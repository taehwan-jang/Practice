...
-이와 같은 내부클래스를 static으로 선언하면 Nested클래스라고 한다.
-정적 멤버 변수, 정적 멤버 메소드를 가질 수 있다.
...
class OuterClass {
	...
	void outerMemberMethod() {
		/*
		외부클래스의 멤버메소드에서는 내부정적클래스의 멤버에 접근할 수 있다.
	...
	//외부클래스의 정적 멤버 변수와 메소드
	static int outerStaticVar;
	static void outerStaticMethod() {
		/*
		외부 클래스의 정적 멤버 메소드에서는 내부클래스의 정적멤버만
...
public class E02InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		내부정적 클래스의 인스턴스형 멤버에 접근할때는 객체를 생서한 후
		참조변수를 통해 접근해야 한다.
		 */
